...
file = input("What file should I encode?: ")
...
if int(round(int(file_size) / int(38400))) < 1:
    print("Generating 1 image...")
elif int(round(int(file_size) / int(38400))) >= 1:
    print("Generating " + str(round(int(file_size) / int(38400))) + " images...")
